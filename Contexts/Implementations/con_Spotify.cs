...
namespace XLink.Contexts.Implementations
{
    public class con_Spotify : Context
    {
        ...
        public con_Spotify() : base("Spotify", ContextType.WebAPI)
        { }
        ...
        public override bool Init()
        {
            ...
            if (tokens == null)
            {
                Logger.Log("Error getting tokens.", LogLevel.Error);
                return false;
            }
        ...
        {
            return new string[] { "ClientId", "ClientSecret", "RedirectUri", "DeviceId", "Scopes", "UserId" };
        }
